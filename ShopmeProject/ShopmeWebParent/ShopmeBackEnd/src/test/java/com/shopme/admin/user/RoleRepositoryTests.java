...
public class RoleRepositoryTests {
	...
	public void testCreateRestRoles() {
		Role roleSalePerson = new Role("Salesperson",
				"manage product price, " + "cutomers, shipping, orders and sales report");
		

		Role roleEditor = new Role("Editor", "manage product price, " + "cutomers, shipping, orders and sales report");
